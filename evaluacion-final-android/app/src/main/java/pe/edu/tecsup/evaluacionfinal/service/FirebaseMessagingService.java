package pe.edu.tecsup.evaluacionfinal.service;
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        try {
            ...
            if (remoteMessage.getNotification() != null) {
                ...
                // Sound
                Uri soundUri = (sound == null || "default".equals(sound))?
                        RingtoneManager.getDefaultUri(RingtoneManager.TYPE_NOTIFICATION):
                        Uri.parse(ContentResolver.SCHEME_ANDROID_RESOURCE + "://" + this.getPackageName() + "/raw/" + sound);
...
//                    intent.putExtra("ACTION", data.getString("ACTION")); // Additional data
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                    // NotificationChannel en Android 8:
